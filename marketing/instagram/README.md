...
| `carousel-en/*.png` | **English carousel — UK** (8 slides): produces an English legal letter (rent-increase challenge, Housing Act 1988); angle „not a template, real analysis"; delivery via post/fax/Signed For | 1080×1350 |
| `CAPTIONS-EN.md` | English (UK) Instagram caption + hashtags | — |
