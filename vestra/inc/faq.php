...
function vestra_faq_en(){
  ...
  'about'=>['title'=>'About VESTRA','items'=>[
    ...
    ['q'=>'What makes VESTRA different from other wholesale platforms?',
     'a'=>'VESTRA combines verified authenticity, third-party escrow payment (funds never held by VESTRA), Group Buying (pool with other buyers to unlock volume prices), and a Sourcing Requests board — all in one secure B2B environment designed for fashion wholesale.'],
  ]],
  ...
  'registration'=>['title'=>'Registration & Account','items'=>[
    ...
    ['q'=>'Is registration free?',
     'a'=>'Creating an account is free. Platform fees (buyer-protection fee and seller commission) apply only when a transaction takes place. Membership plans may be introduced in the future and will always be disclosed before they apply.'],
  ...
  'payment'=>['title'=>'Payment & Escrow','items'=>[
    ...
    ['q'=>'What payment methods are accepted?',
     'a'=>'SEPA Credit Transfer is the primary method for EU-based B2B buyers. Card payment is also available (subject to provider fees). Cryptocurrency and cheques are not accepted.'],
    ...
    ['q'=>'Is there a buyer-protection fee?',
     'a'=>'Yes. A small buyer-protection fee (currently 2% of the order value) is charged to buyers. This fee funds the escrow mechanism, dispute resolution, and platform security. It is shown clearly before you confirm the order.'],
    ['q'=>'Is my payment information safe?',
     'a'=>'Yes. All payment data is processed exclusively by the licensed escrow/payment provider. VESTRA never sees or stores your bank details or card numbers.'],
  ]],
  ...
  'shipping'=>['title'=>'Shipping & Delivery','items'=>[
    ...
    ['q'=>'What if goods arrive damaged in transit?',
     'a'=>'Document the damage with photographs immediately upon delivery, before signing the carrier\'s receipt. Open a dispute within 48 hours of delivery. Do not return goods without VESTRA\'s written confirmation — unauthorised returns complicate the escrow release process.'],
  ]],

  'disputes'=>['title'=>'Disputes & Returns','items'=>[
    ['q'=>'What if the goods do not match the listing description?',
     'a'=>'If goods are materially different from the listing (wrong model, quantity, colour, or undisclosed defects), open a dispute in your account dashboard within 5 business days of confirmed delivery. Include photographs and a written description. Escrow funds will remain frozen during the review.'],
    ...
    ['q'=>'What if I receive counterfeit goods?',
     'a'=>'This is treated as the most serious category of dispute. Funds are immediately frozen. Document the goods thoroughly. VESTRA will initiate an IP investigation, liaise with the rights holder if available, and — if counterfeiting is confirmed — issue a full refund from escrow and suspend the seller.'],
    ['q'=>'How long do I have to raise a dispute?',
     'a'=>'You must raise a dispute within 5 business days of the confirmed delivery date (or, for non-delivery, by the agreed delivery deadline). After this window the escrow auto-releases to the seller and disputes become significantly harder to resolve.'],
    ['q'=>'What happens if a dispute is resolved in my favour?',
     'a'=>'Escrowed funds are refunded to you in full (or partially, as agreed). The seller may be issued a strike or suspended depending on the severity of the breach.'],
  ]],
  ...
  'selling'=>['title'=>'Selling on VESTRA','items'=>[
    ...
    ['q'=>'What commission does VESTRA charge sellers?',
     'a'=>'VESTRA charges a 7% commission on each successful sale, deducted from the escrowed amount before payout. Additional membership or listing fees may apply in the future and will be communicated in advance.'],
    ['q'=>'How and when do I receive payment?',
     'a'=>'After the buyer confirms receipt (or the auto-release window expires with no dispute), the escrow provider disburses your payout — order value minus VESTRA\'s 7% commission — directly to your registered bank account. Typical processing time is 1–3 business days.'],
  ...
  'authenticity'=>['title'=>'Authenticity & Intellectual Property','items'=>[
    ...
    ['q'=>'What happens if someone lists counterfeit goods?',
     'a'=>'Confirmed counterfeiting results in immediate listing removal, seller suspension, funds frozen in escrow, potential refund to buyer, and referral to the relevant rights holder and/or authorities. We operate a zero-tolerance policy.'],
  ...
  'fees'=>['title'=>'Fees & Pricing','items'=>[
    ['q'=>'Is it free to use VESTRA as a buyer?',
     'a'=>'Browsing and registering are free. When you place an order you pay a 2% buyer-protection fee on the order value. This is shown clearly at checkout.'],
    ['q'=>'What is the seller commission?',
     'a'=>'VESTRA charges sellers a 7% commission on each completed transaction. This is deducted from the escrowed amount before payout. There are no listing fees currently.'],
    ['q'=>'Are there any membership or subscription fees?',
     'a'=>'Currently there are no mandatory membership fees. Optional premium membership plans may be introduced in the future; they will always be opt-in and announced with advance notice.'],
    ['q'=>'Are platform fees refundable?',
     'a'=>'Platform fees are non-refundable except where required by law, or where a transaction is cancelled before funds leave escrow (e.g., a seller fails to confirm the order within the acceptance window). If a dispute is resolved in your favour, the full order value including your buyer-protection fee is refunded.'],
  ]],
