...
function vestra_faq_en(){
  ...
  'shipping'=>['title'=>'Shipping & Delivery','items'=>[
    ...
    ['q'=>'What if goods arrive damaged in transit?',
     'a'=>'Document the damage with photographs immediately upon delivery, before signing the carrier\'s receipt. File the claim within 3 business days of delivery. Do not return goods without VESTRA\'s written confirmation — unauthorised returns complicate the resolution.'],
  ]],
  ...
  'returns'=>['title'=>'Returns & Claims','items'=>[
    ...
    ['q'=>'How long do I have to report it?',
     'a'=>'Three business days. You must notify us within 3 business days of delivery — Monday to Friday; Saturdays and Sundays do not count. This is the single deadline that matters: after it passes the delivery counts as accepted and any funds still held for the order are no longer held. There is no extension for public holidays, staff absence, or unopened cartons — if you cannot inspect a delivery within three business days, arrange for someone who can.'],
    ['q'=>'How exactly are the 3 days counted?',
     'a'=>'Business days, not calendar days — Saturdays and Sundays are not counted — starting from the delivery date recorded by the carrier or confirmed in your order. A delivery on Friday must be reported by the following Wednesday. The clock stops the moment your claim is submitted in the platform — not when the seller replies to it.'],
    ...
    ['q'=>'Does filing a claim stop my payment going to the seller?',
     'a'=>'Yes. Funds are not released while a claim is open, and the automatic release is set so that it cannot happen before your 3 business days have run. This is the practical reason the deadline is short: your money is held for exactly as long as your right to complain lasts.'],
    ...
    ['q'=>'What is the shortest possible summary?',
     'a'=>'No returns for change of mind. Wrong, missing or faulty goods only. Tell us within 3 business days of delivery, with photographs, through the platform. Do not ship anything back until we authorise it in writing.'],
  ]],

  'disputes'=>['title'=>'Disputes & Returns','items'=>[
    ['q'=>'What if the goods do not match the listing description?',
     'a'=>'If goods are materially different from the listing (wrong model, quantity, colour, or undisclosed defects), open a dispute in your account dashboard within 3 business days of delivery — see Returns & Claims for what to send. Include photographs and a written description. Hold any further payments to the seller while the review runs.'],
    ...
    ['q'=>'Can I return goods?',
     'a'=>'Wholesale orders are closed to returns: there is no return for change of mind, and no statutory withdrawal right on a B2B purchase. Goods that are wrong, missing or faulty are claimable within 3 business days of delivery. The full rules, the evidence to send and who pays the return freight are set out under Returns & Claims.'],
    ...
    ['q'=>'How long do I have to raise a dispute?',
     'a'=>'Within 3 business days of delivery (or, for non-delivery, by the agreed delivery deadline). After this window the delivery is treated as accepted and any funds still held for the order are no longer held. The same 3 business days apply to every claim reason — wrong, missing, faulty or not-as-described.'],
