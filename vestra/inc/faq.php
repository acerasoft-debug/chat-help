...
function vestra_faq_en(){
  ...
  'selling'=>['title'=>'Selling on VESTRA','items'=>[
    ...
    ['q'=>'What commission does VESTRA charge sellers?',
     'a'=>'VESTRA charges a 3.5% commission on each order\'s goods value. It\'s collected automatically from the card you add in your seller profile the moment the buyer\'s payment is confirmed — no invoicing, no manual transfers, and it never changes what the buyer pays.'],
    ['q'=>'How and when do I receive payment?',
     'a'=>'Directly and before shipping: the buyer pays your invoice by bank transfer straight to the bank account you set in your seller profile — VESTRA is never in that payment chain. Ship as soon as it arrives. Separately, the 3.5% commission is charged to your commission card once the order is marked paid.'],
  ...
  'fees'=>['title'=>'Fees & Pricing','items'=>[
    ...
    ['q'=>'What is the seller commission?',
     'a'=>'VESTRA charges sellers a 3.5% commission on each paid order\'s goods value, charged automatically to the card on file. This is separate from — and in addition to — the monthly membership plan.'],
    ['q'=>'Are there any membership or subscription fees?',
     'a'=>'For buyers: never. For sellers: publishing listings requires an active membership plan (Starter €19.90 — up to 10 listings/month; Pro €39 or Premium €89 per month — unlimited listings; all after a 30-day free trial). Plans are shown on the Membership page.'],
