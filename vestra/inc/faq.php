...
function vestra_faq_en(){
  ...
  'selling'=>['title'=>'Selling on VESTRA','items'=>[
    ...
    ['q'=>'What commission does VESTRA charge sellers?',
     'a'=>'None — VESTRA currently charges 0% commission. The platform is funded by seller membership plans instead, so 100% of the invoice amount goes to you. Any future change would be announced well in advance.'],
    ['q'=>'How and when do I receive payment?',
     'a'=>'Directly and before shipping: the buyer pays your invoice by bank transfer straight to the bank account you set in your seller profile. Ship as soon as the payment arrives — there is no platform payout step or waiting window.'],
  ...
  'fees'=>['title'=>'Fees & Pricing','items'=>[
    ...
    ['q'=>'What is the seller commission?',
     'a'=>'There is no seller commission — 0%. Sellers publish with a membership plan (Starter, Pro, or Premium; 30-day free trial) and keep 100% of their sales.'],
    ['q'=>'Are there any membership or subscription fees?',
     'a'=>'For buyers: never. For sellers: publishing listings requires an active membership plan (Starter €19, Pro €39, or Premium €89 per month, after a 30-day free trial). Plans are shown on the Membership page.'],
