...
/* Dil ve para birimi menuleri: disariya tiklayinca ve Escape'te kapansin. <details>
...
document.addEventListener('click',function(e){
  document.querySelectorAll('details.cursw[open],details.langsw[open]').forEach(function(d){
    if(!d.contains(e.target)) d.removeAttribute('open');
  });
});
document.addEventListener('keydown',function(e){
  if(e.key==='Escape') document.querySelectorAll('details.cursw[open],details.langsw[open]').forEach(function(d){
