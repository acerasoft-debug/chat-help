<?php
/**
 * ChatHelp — apply-vize-v2-prompts (CH_VIZE_V2P) — V2 belge sablonlari
 ...
 * KULLANIM: pull2.php?key=...&files=apply-vize-v2-prompts.php
 */
header('Content-Type: text/plain; charset=UTF-8');
error_reporting(E_ERROR | E_PARSE);
echo "apply-vize-v2-prompts BASLADI OK (PHP ".PHP_VERSION.")\n\n";
