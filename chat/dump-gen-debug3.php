<?php
/** ChatHelp — dump-gen-debug3 (yeniden adlandirildi, edge cache atlatmak icin): son belge uretiminde ne alindi/ne uretildi (CH_GENDEBUG ciktisi).
 *  SADECE OKUR. SIL: rm dump-gen-debug3.php */
...
echo "\n=== BITTI. TAMAMINI yapistir. SIL: rm dump-gen-debug3.php ===\n";
